...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    public static void main(String[] a)
    {
        ...
        bob.up();
        bob.setPosition(-90, 240);
        bob.dot("yellow", 100);

        bib.penColor("green");

        bib.setPosition(-100, 0); // Start at the center // Set a higher speed for smoother drawing
        bib.forward(150);
        bib.setPosition(-100, 0);
        for (int i = 0; i < 10; i++) {
            bib.right(i*3.5);
            bib.backward(5);
        }
        ...
        bib.up();
        bib.setPosition(-2, 10,65);
        bib.down();
        bib.forward(38); //18 30
        bib.setDirection(-65);
        bib.forward(30);

        bib.up();
        bib.setPosition(30, 18,65);
        bib.down();
        bib.forward(30);
        bib.setDirection(-65);
        bib.forward(26);
        ...
        bib.up();
        bib.setPosition(-62, 34,45);
        bib.down();
        bib.forward(22); //38 20
        bib.setDirection(-45);
        bib.forward(22);

        bib.up();
        bib.setPosition(-20, 34,45);
        bib.down();
        bib.forward(22); //38 20
        bib.setDirection(-45);
        bib.forward(20);
        ...
        bob.penColor("white");
        bob.up();
        bob.setPosition(-15, 41,95);
        bob.down();
        bob.forward(20);
        
        bob.up();
        bob.setPosition(-17, 61,180);
        bob.down();
        bob.forward(3);
        bob.setDirection(95);
        bob.forward(40);
        bob.setDirection(5);
        bob.forward(6);
        bob.setDirection(275);
        bob.forward(40);
        bob.setDirection(185);
        bob.forward(2);

        bob.up();
        bob.setPosition(-4, 49,90);
        bob.down();
        bob.forward(12);
        ...
        bob.up();
        bob.setPosition(10, 40,90);
        bob.down();
        bob.forward(21); //49 12
        bob.down();
        bob.setDirection(180);
        bob.forward(3);
        bob.setDirection(90);
        ...
        bob.forward(20);
        bob.up();
        bob.setPosition(-130, 155);
        bob.down();
        bob.dot("red");

        bob.up();
        bob.penColor(Color.yellow);
        bob.setPosition(60, 170,90);
        bob.down();
        bob.forward(30);
        bob.setDirection(0);
        bob.forward(20);
        ...
        bob.forward(20);
        bob.up();
        bob.setPosition(70, 175);
        bob.down();
        bob.dot("red");

        bob.up();
        bob.penColor(Color.yellow);
        bob.setPosition(90, 60,90);
        bob.down();
        bob.forward(30);
        bob.setDirection(0);
        bob.forward(20);
        ...
        bob.forward(20);
        bob.up();
        bob.setPosition(100, 70);
        bob.down();
        bob.dot("red");
        
        bob.up();
        bob.penColor("gold");
        bob.setPosition(110, 120);
        bob.down();
        for (int i = 0; i < 36; i++) {
            bob.right(170);
            bob.forward(60);
